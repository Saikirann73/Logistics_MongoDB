...
def plane_unit_tests():
    ...
    planefields = { "callsign" : str, "heading": int, "currentLocation": list, "route" : list, "landed": str}
    print("Testing GET /planes")
    r = requests.get(url + "/planes", verify=False)
    test_response(r,200,list,planefields)

    print("Testing GET /planes/CARGO0")
    r = requests.get(url + "/planes/CARGO0", verify=False)
    test_response(r,200,dict,planefields)

    print("Testing GET /planes/AIRWOLF")
    r = requests.get(url + "/planes/AIRWOLF", verify=False)
    test_response(r,404,dict,planefields)

    print("Testing PUT /planes/CARGO0/location/5.5,56.5/180")
    r = requests.put(url + "/planes/CARGO0/location/5.5,56.5/180", verify=False)
    ...
    r = requests.put(url + "/planes/CARGO0/location/5.5,56.5/180/Edinburgh", verify=False)
    test_response(r,400,None,planefields)


    print("Testing PUT /planes/CARGO0/location/5.5,56.5/180/Madrid")
    r = requests.put(url + "/planes/CARGO0/location/5.5,56.5/180/Madrid", verify=False)
    test_response(r,200,None,planefields)
    r = requests.get(url + "/planes/CARGO0", verify=False)
    test_response(r,200,dict,planefields)
    o = r.json()
    ...
    r = requests.put(url + "/planes/CARGO1/route/Gondor", verify=False)
    test_response(r,400,None,planefields)

    print("Testing PUT /planes/CARGO1/route/Paris")
    r = requests.put(url + "/planes/CARGO1/route/Paris", verify=False)
    test_response(r,200,None,planefields)
    r = requests.get(url + "/planes/CARGO1", verify=False)
    test_response(r,200,dict,planefields)
    o = r.json()
    ...
    r = requests.post(url + "/planes/CARGO1/route/Berlin", verify=False)
    test_response(r,200,None,planefields)
    r = requests.get(url + "/planes/CARGO1", verify=False)
    test_response(r,200,dict,planefields)
    o = r.json()
    ...
    r = requests.post(url + "/planes/CARGO1/route/Atlantis", verify=False)
    test_response(r,400,None,planefields)

    print("Testing DELETE /planes/CARGO1/route/destination")
    r = requests.delete(url + "/planes/CARGO1/route/destination", verify=False)
    test_response(r,200,None,planefields)
...
def cargo_unit_tests():
    ...
    r = requests.post(url + "/cargo/Berlin/to/London", verify=False)
    ...
    r = requests.get(url + "/cargo/location/Berlin", verify=False)
    ...
    r = requests.put("%s/cargo/%s/courier/CARGO0" % (url,id), verify=False)
    ...
    r = requests.delete("%s/cargo/%s/courier" % (url,id), verify=False)
    test_response(r,200,None,cargofields)
    ...
    r = requests.put("%s/cargo/%s/location/CARGO1" % (url,id), verify=False)
    test_response(r,200,None,cargofields)

    print("Testing GET /cargo/location/CARGO1")
    r = requests.get(url + "/cargo/location/CARGO1", verify=False)
    test_response(r,200,list,cargofields)
    try:
        o = r.json()
    except Exception as e:
    ...
    r = requests.put("%s/cargo/%s/delivered" % (url,id), verify=False)
    test_response(r,200,None,cargofields)
